                ...
                for b in content:
                    ...
                    if b.get("type") == "text":
                        ...
                        if name == "Bash":
                            ...
                            labels = [l for l in (resolve(s) for s in split_segments(cmd)) if l]
                            meaty = [l for l in labels if l.split()[0] not in TRIVIAL]
                            name = "Bash: " + (meaty or labels or ["(cd / no-op)"])[0]
